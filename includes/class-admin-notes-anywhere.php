...
class Admin_Notes_Anywhere {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Admin_Notes_Anywhere_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ADMIN_NOTES_ANYWHERE_VERSION' ) ) {
			$this->version = ADMIN_NOTES_ANYWHERE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'admin-notes-anywhere';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-admin-notes-anywhere-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-admin-notes-anywhere-i18n.php';
	 ...
	 *
	 * Uses the Admin_Notes_Anywhere_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Admin_Notes_Anywhere_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Admin_Notes_Anywhere_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Admin_Notes_Anywhere_Loader    Orchestrates the hooks of the plugin.
	 */
